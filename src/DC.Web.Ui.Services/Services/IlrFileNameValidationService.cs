...
namespace DC.Web.Ui.Services.Services
{
    public class IlrFileNameValidationService : AbstractFileNameValidationService
    {
        ...
        protected override Regex FileNameRegex => new Regex("^(ILR)-([1-9][0-9]{7})-([1-9]{4})-((20[0-9]{2})(0[1-9]|1[012])([123]0|[012][1-9]|31))-(([01][0-9]|2[0-3])([0-5][0-9])([0-5][0-9]))-([0-9]{2}).((XML)|(ZIP)|(xml)|(zip))$", RegexOptions.Compiled);
